...
#define NUMBER_OF_CELLS_INPUT 15
#define MAX_NUMBER_OF_CELLS 12
...
#define N_BATTERY_CELLS_SHORT  3
const int cellShort[N_BATTERY_CELLS_SHORT] = {4, 9, 14};
...
class bq769x0 {
  ...
  public:
    ...
    bq769x0(TwoWire *theWire =nullptr,byte bqType = bq76920, int bqI2CAddress = 0x18);
