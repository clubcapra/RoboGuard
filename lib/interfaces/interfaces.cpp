...
void setup_interfaces(){
    ...
    /*
    bms.begin(alert_BMS, boot_BMS);

    bms.setThermistorBetaValue(THERM_B);
    bms.setTemperatureLimits(BATT_MIN_TEMP, BATT_MAX_TEMP, 100, 100);
    bms.setCellUndervoltageProtection(BATT_CELL_MIN_V_BMS);
    bms.setCellOvervoltageProtection(BATT_CELL_MAX_V_BMS);
